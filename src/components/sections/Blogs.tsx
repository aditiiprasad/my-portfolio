...
const Blogs = () => {
  const blogs = [
    ...
    {
      title: "Purplle SDE Intern Interview Experience 2026 (Off-Campus)",
      snippet: "This article is about my experience participating in the Purplle Tech Challenge 2026 and the interview process that followed.",
      date: "Jul 11, 2026                                                   ",
      color: "bg-custom-pink",
      link: "https://aditiiprasad.medium.com/purplle-sde-intern-interview-experience-2026-off-campus-c2f91f90350a",
    }
  ];
